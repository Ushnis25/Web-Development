...
if(isset($_POST["adda3"]))
{
	...
	(SlNo, PayeeName,AccNo,AccType,BankName,IFSCCode)
	VALUES
...
{ 					
	mysql_query("UPDATE registered_payee SET PayeeName='$_POST[p_name3]',AccNo='$_POST[ac_no3]',AccType='$_POST[ac_type3]',BankName='$_POST[bank_name3]',IFSCCode='$_POST[code3]' WHERE SlNo='$_POST[pid3]'");
